...
> **Revision:** 1.0.0
> **Implements:** LOCK-04 (Modular), LOCK-09 (AI Discipline); EC-01 (Documentation First), EC-02 (One Source of Truth), EC-03 (Component Reuse First), EC-07 (Performance Budget), EC-08 (Security by Default), EC-09 (Testing Philosophy), EC-10 (Design System Governance)
...
- Testing strategy and framework choices → `21_TestingStrategy`.
- PR workflow and branching → `20_DevelopmentGuideline`.
...
- `20_DevelopmentGuideline` — PR workflow enforcing these standards.
- `21_TestingStrategy` — testing standards complement these.
...
- `12_ACD` — Reusable components from `@packages/ui`.
- `14_DatabaseDesign` — RLS policies complement security rules.
- `15_APIConvention` — API-specific coding rules.
- `18_RBAC` — Authorization rules enforced in server actions.
- `20_DevelopmentGuideline` — PR workflow including this checklist.
- `21_TestingStrategy` — Testing standards referenced in §11.
- `22_DeploymentGuide` — CI pipeline runs these checks.
- `23_AI_Guideline` — AI must follow these standards (LOCK-09, EC-11).
