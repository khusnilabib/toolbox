// src/tools/developer/base64-encoder/stages/preview.tsx
  ...
  return (
    <div className="space-y-4">
      <dl className="grid grid-cols-2 gap-2 text-xs sm:grid-cols-2">
        <Meta label="Original length" value={`${output.originalLength} chars`} />
        <Meta label="Result length" value={`${output.resultLength} chars`} />
      </dl>
