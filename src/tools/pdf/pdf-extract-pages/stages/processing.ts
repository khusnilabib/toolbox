// src/tools/pdf/pdf-extract-pages/stages/processing.ts
...
export const processingStage: ProcessingStage<ToolInput, ToolOutput> = async (ctx) => {
  ...
  // Lazy-load pdf-lib via shared utils (LOCK-06). The requested page range is
  // parsed, bounds-checked against the document, and copied into a new PDF.
